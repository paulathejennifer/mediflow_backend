...
class PatientService:
    ...
    def create_patient(
        self, patient_data: PatientCreate, facility_id: int, creator_id: int
        ...
        patient, identifier = mrn_service.create_patient_with_mrn(
            patient_data.dict(), facility_id, facility.facility_code
        )
    ...
    def update_patient(
        self, patient_id: int, patient_update: PatientUpdate, updater_id: int
    ) -> Patient:
        """
    ...
    def get_patient_summary(self, patient_id: int, facility_id: int) -> Dict[str, Any]:
        ...
        total_referrals = (
            self.db.query(Referral).filter(Referral.patient_id == patient_id).count()
        )
    ...
    def merge_patients(
        self, primary_patient_id: int, duplicate_patient_id: int, merger_id: int
    ) -> Patient:
        """
        ...
        self.db.query(Referral).filter(
            Referral.patient_id == duplicate_patient_id
        ).update({"patient_id": primary_patient_id})
    ...
    def get_patient_demographics(self, facility_id: int) -> Dict[str, Any]:
        ...
        patients = self.get_facility_patients(
            facility_id, limit=10000
        ...
        age_groups = {"0-17": 0, "18-30": 0, "31-50": 0, "51-65": 0, "65+": 0}
