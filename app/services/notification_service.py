...
from app.models.notifications import (
    ...
    SystemMetric, NotificationPreference, NotificationQueue
)
...
class NotificationService:
    ...
    def create_notification(self, 
        ...
        import asyncio
        asyncio.create_task(self.broadcaster.broadcast_notification(notification, self.db))
    ...
    def create_emergency_referral_notification(self, referral: Referral) -> Notification:
        ...
        notification = self.create_notification(
            ...
            details={
                ...
                "referring_facility": referral.from_facility.name if referral.from_facility else "Unknown"
            },
    ...
    def create_hipaa_violation_notification(self, audit_log: AuditLog) -> Notification:
        ...
        notification = self.create_notification(
            ...
            details={
                ...
                "facility": audit_log.user.facility.name if audit_log.user and audit_log.user.facility else "Unknown"
            },
    ...
    def create_ai_service_down_notification(self, service_name: str, error_details: Dict[str, Any]) -> Notification:
    ...
    def create_referral_delay_notification(self, facility_id: int, delay_details: Dict[str, Any]) -> Notification:
        ...
        notification = self.create_notification(
            ...
            details={
                ...
                "affected_departments": delay_details.get("affected_departments", ["Cardiology", "Neurology"])
            },
    ...
    def create_ai_performance_notification(self, performance_details: Dict[str, Any]) -> Notification:
        ...
        notification = self.create_notification(
            ...
            details={
                ...
                "required_minimum": "90%",
                "affected_services": performance_details.get("affected_services", ["whisper", "ocr"]),
    ...
    def create_storage_warning_notification(self, facility_id: int, storage_details: Dict[str, Any]) -> Notification:
    ...
    def create_referral_status_notification(self, referral: Referral) -> Notification:
        ...
        notification = self.create_notification(
            ...
            details={
                ...
                "referral_id": f"R-{referral.id}",
                "accepting_facility": referral.to_facility.name if referral.to_facility else "Unknown",
                "accepting_physician": referral.accepted_by_user.first_name if referral.accepted_by_user else "Unknown",
                "estimated_arrival": referral.created_at.isoformat() if referral.created_at else None
            },
    ...
    def create_voice_note_transcribed_notification(self, voice_note_details: Dict[str, Any]) -> Notification:
        ...
        notification = self.create_notification(
            ...
            details={
                ...
                "processing_time": voice_note_details.get("processing_time", "1.1 minutes")
            },
    ...
    def create_team_performance_notification(self, facility_id: int, performance_data: Dict[str, Any]) -> Notification:
        ...
        notification = self.create_notification(
            ...
            details={
                "top_performer": performance_data.get("top_performer", "Dr. Mike Wilson"),
                "avg_referral_time": performance_data.get("avg_referral_time", "1.2 hours"),
                "patient_satisfaction": performance_data.get("patient_satisfaction", "4.7/5.0"),
        ...
        for service in services:
            ...
            if is_down:
                ...
                if not recent_notification:
                    self.create_ai_service_down_notification(service, {
                        "error_count": 127,
                        "last_success": datetime.now(timezone.utc) - timedelta(minutes=30)
                    })
    ...
    def monitor_storage_usage(self):
        ...
        for facility in facilities:
            ...
            if storage_usage >= 0.85:  # 85% threshold
                ...
                if not recent_notification:
                    self.create_storage_warning_notification(facility.id, {
                        "used_storage": "4.2TB",
                        "total_storage": "5TB",
                        "days_until_full": 7,
    ...
    def monitor_referral_performance(self):
        ...
        overdue_referrals = self.db.query(Referral).filter(
        ...
        if overdue_referrals > 40:  # Threshold for warning
            ...
            if not recent_notification:
                self.create_referral_delay_notification(None, {
                    "sla_target": "2 hours",
    ...
    def get_notification_stats(self, user_id: int, user_role: str) -> Dict[str, Any]:
        ...
        stats = {
            ...
            "critical": len([n for n in notifications if n.notification_type == "critical"]),
            "warning": len([n for n in notifications if n.notification_type == "warning"]),
            "info": len([n for n in notifications if n.notification_type == "info"]),
            "expired": len([n for n in notifications if n.expires_at and n.expires_at < datetime.now(timezone.utc)])
        }
