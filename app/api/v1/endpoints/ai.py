...
def generate_referral_ai_summary(
    ...
    try:
        ...
        context = {
            ...
            "age": referral_service._calculate_age(referral_summary['patient_info']['date_of_birth']) if referral_summary['patient_info'] and referral_summary['patient_info']['date_of_birth'] else "Unknown",
            ...
            "documents_summary": referral_service._summarize_documents(referral_summary['attachments']['documents']),
            "voice_transcripts": referral_service._summarize_voice_notes(referral_summary['attachments']['voice_notes']),
