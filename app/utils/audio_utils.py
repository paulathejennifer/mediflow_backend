...
class AudioProcessor:
    ...
    def normalize_audio(input_path: str, output_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if AudioProcessor._check_ffmpeg_available():
                return AudioProcessor._normalize_with_ffmpeg(input_path, output_path, input_info)
            else:
                # Fallback to basic processing
                return AudioProcessor._normalize_basic(input_path, output_path, input_info)
    ...
    @staticmethod
    def _normalize_with_ffmpeg(input_path: str, output_path: str, input_info: Dict[str, Any]) -> Dict[str, Any]:
        """Normalize audio using ffmpeg."""
        try:
            # Build ffmpeg command for normalization
            cmd = [
                'ffmpeg', '-i', input_path,
                '-ar', str(AudioProcessor.TARGET_SAMPLE_RATE),  # Sample rate
                '-ac', str(AudioProcessor.TARGET_CHANNELS),     # Channels
    ...
    @staticmethod
    def _normalize_basic(input_path: str, output_path: str, input_info: Dict[str, Any]) -> Dict[str, Any]:
    ...
    @staticmethod
    def convert_format(input_path: str, output_path: str, target_format: str = 'wav') -> Dict[str, Any]:
        """
    ...
    def extract_audio_segment(input_path: str, output_path: str, 
                           start_seconds: float, duration_seconds: float) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            cmd = [
                ...
                '-acodec', 'copy',  # Copy codec without re-encoding
                '-y',  # Overwrite output file
                output_path
            ]
