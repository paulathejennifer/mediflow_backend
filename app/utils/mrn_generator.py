...
class MRNGenerator:
    ...
    def generate_facility_code(facility_name: str) -> str:
        ...
        common_words = {
            'hospital', 'medical', 'center', 'centre', 'clinic', 'health',
            'referral', 'national', 'regional', 'county', 'district',
            'memorial', 'general', 'teaching', 'university'
        }
    ...
    @staticmethod
    def generate_mrn_batch(facility_code: str, start_number: int, count: int) -> List[str]:
        """
    ...
    def validate_mrn_with_checksum(mrn: str) -> bool:
        ...
        try:
            ...
            expected_checksum = MRNGenerator.generate_mrn_checksum(facility_code, patient_number)
